...
**Модель:** используется `gpt-4o-mini` (обычный режим) и `gpt-4` (острый). Требование требует только OpenAI API, модель не специфицирована жёстко.
...
| Валидация <3, >7, пустой язык | ✅ | script.js:250-270 |
